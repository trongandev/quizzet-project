...
export const MultiSelect = React.forwardRef<HTMLButtonElement, MultiSelectProps>(({ options, onValueChange, variant, defaultValue = [], placeholder = "Chọn loại câu hỏi", animation = 0, maxCount = 3, modalPopover = false, asChild = false, className, ...props }, ref) => {
