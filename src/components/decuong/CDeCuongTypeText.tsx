...
export default function CDeCuongTypeText({ findText }: { findText: ISO[] }) {
    ...
    return (
        <div className="p-2 md:p-0 mt-10 flex flex-col gap-5  ">
            ...
            <div className={`grid grid-cols-2 md:grid-cols-3 gap-4 ${viewMode === 4 ? "lg:grid-cols-4" : "lg:grid-cols-3"} h-[416px] overflow-y-scroll`}>
                {displaySO?.map((item: any, index: any) => (
                    <div className="bg-white dark:bg-slate-800/50 hover:shadow-md rounded-xl h-[200px] flex flex-col md:flex-row overflow-hidden shadow-sm border border-white/10 group " key={index}>
