...
import { QuizAIText } from "@/components/ai-center/create-with-ai/typeCreateAI"
import { topicOptionsTemplate } from "@/components/ai-center/create-with-ai/configEnglish"
        ...
        <Card className=" ">
            ...
            <CardContent className="space-y-3">
                <div className="space-y-1">
                    ...
                    <Textarea id="textInput" value={dataQuizText.content} onChange={(e) => handleChangeValue("content", e.target.value)} placeholder="Nhập văn bản của bạn ở đây..." className="h-[300px] multiline-placeholder" />
                </div>
                ...
                <Button size="lg" className="dark:text-white bg-gradient-to-r from-purple-500 to-pink-500 hover:opacity-90" onClick={() => handleGenerate(dataQuizText, "text")} disabled={!dataQuizText.content.trim() || isGenerating}>
                    {isGenerating ? (
                        <>
