...
import { Bot, FileText, ListTodo, Upload } from "lucide-react"
import { SidebarTrigger } from "../ui/sidebar"
import { useRouter } from "next/navigation"

export function HomeViewAI() {
    ...
    return (
        <div className="p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
                {options.map((option) => (
                    <Card key={option.id} className="relative overflow-hidden hover:shadow-lg transition-all duration-300 cursor-pointer group" onClick={() => router.push(`/ai-center/create-with-ai/${option.id}`)}>
