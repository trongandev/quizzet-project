        ...
        >
            <div className="relative w-full h-32">
                <Image
                    src={post.img}
                    alt=""
                    className="absolute object-cover group-hover:brightness-75 transition-all duration-300"
                    fill
                ></Image>
                <Badge
                    variant="secondary"
                    className="text-xs absolute z-1 top-1 left-1"
                >
                    {post.subject}
                </Badge>
                <Button
