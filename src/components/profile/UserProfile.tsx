                ...
                <div className="p-2 md:px-5 py-20 flex flex-col gap-5 min-h-screen">
                                ...
                                <div className="flex-1 text-center md:text-left">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <p className="text-xs text-slate-400">
                                            Còn {xpForNextLevel - currentXP} XP
                                            để lên cấp {nextLevel}
                                        </p>
                                    </div>
                                </div>
                                        ...
                                        <div className="space-y-3 dark:text-slate-300">
                                            <div className="p-3 dark:bg-slate-700 rounded-lg">
                                                ...
                                                <p className="text-sm dark:text-slate-300">
                                                    Học viên tập sự, Người khám
                                                    phá từ vựng, Người làm chủ
                                                    chữ cái...
                                                </p>
                                            </div>
                                            <div className="p-3 dark:bg-slate-700 rounded-lg">
                                                ...
                                                <p className="text-sm dark:text-slate-300">
                                                    Thợ rèn từ, Người kể chuyện,
                                                    Đàm phán viên ngôn ngữ...
                                                </p>
                                            </div>
                                            <div className="p-3 dark:bg-slate-700 rounded-lg">
                                                ...
                                                <p className="text-sm dark:text-slate-300">
                                                    Người bạn của từ, Nhà thông
                                                    thái ngôn ngữ, Nghệ sĩ từ
                                                    vựng...
                                                </p>
                                            </div>
                                            <div className="p-3 dark:bg-slate-700 rounded-lg">
                                                ...
                                                <p className="text-sm dark:text-slate-300">
                                                    Bậc thầy ngôn ngữ, Ngôn sứ
                                                    từ vựng, Huyền thoại ngôn
                                                    ngữ...
                                                </p>
                                            </div>
                                        </div>
                    ...
                    <div className="">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 max-h-[500px] overflow-y-auto">
                            {quiz &&
                                quiz.map((post, index) => (
                                    <QuizInProfile key={index} post={post} />
                                ))}
                        </div>
                    </div>
                    <div className="mt-5">
