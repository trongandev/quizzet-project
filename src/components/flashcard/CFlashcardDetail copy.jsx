...
export default function CFlashcardDetailS({ id_flashcard }) {
            ...
            <div className="w-full md:w-[1000px] xl:w-[1200px] text-third dark:text-white px-3 md:px-0">
                        ...
                        <Popover
                            content={
                                <div className="flex-1 flex justify-between gap-3 flex-col">
                                    <Button className=" flex items-center gap-1" onClick={showModalEdit}>
                                        <MdEdit /> Chỉnh sửa
                                    </Button>
                                    <Button className="!rounded-md flex items-center gap-1" onClick={showModal}>
                                        <IoMdAdd /> Thêm
                                    </Button>
                                    <Button className="flex items-center gap-1 !rounded-md" onClick={showModalAddMore}>
                                    ...
                                    <div className="">
                                        <Popconfirm
                                            ...
                                            <Button disabled={user?._id == listFlashcard?.userId} className="!bg-red-500 flex items-center gap-1" onClick={showPopconfirm}>
                                                <FaTrash /> Xóa
                                            </Button>
                                        </Popconfirm>
                                    </div>
                    ...
                    {user?._id == listFlashcard?.userId?._id ? (
                        <div className="flex-1 hidden md:flex justify-between gap-2 items-center">
                            <div className="flex gap-2 items-center h-[36px] ">
                                <Button className="h-full !rounded-md" onClick={showModalEdit}>
                                    <MdEdit />
                                </Button>
                                <Button className="h-full !rounded-md flex items-center gap-1" onClick={showModal}>
                                    <IoMdAdd /> Thêm
                                </Button>
                                <Button className="flex items-center gap-1 !rounded-md" onClick={showModalAddMore}>
                                    <AiOutlineAppstoreAdd /> Thêm nhiều
                            ...
                            <div className="">
                                <AlertDialog>
                                    <AlertDialogTrigger asChild>
                                        <Button disabled={user?._id == listFlashcard?.userId} variant="destructive" className=" flex items-center gap-1" onClick={showPopconfirm}>
                                            <FaTrash /> Xóa
                                        </Button>
                                    </AlertDialogTrigger>
                                    <AlertDialogContent>
                                        <AlertDialogHeader>
                                            <AlertDialogTitle>Xóa flashcard này?</AlertDialogTitle>
                                            <AlertDialogDescription>Bạn chắc chứ? nó sẽ không khôi phục được đâu.</AlertDialogDescription>
                                        </AlertDialogHeader>
                                        <AlertDialogFooter>
                                            <AlertDialogCancel>Để suy nghĩ lại</AlertDialogCancel>
                                            <AlertDialogAction onClick={confirm}>Chắc chắn!</AlertDialogAction>
                                        </AlertDialogFooter>
                                    </AlertDialogContent>
                                </AlertDialog>
                            </div>
                    ...
                    <Modal
                        ...
                        <div className="space-y-3">
                            <div className="flex gap-3 items-end">
                                ...
                                <Button className="flex items-center gap-2 !rounded-md" disabled={loading} onClick={handleSendPrompt}>
                ...
                <div className="flex items-center gap-3">
                    <Link href={`/flashcard/practice/${listFlashcard?._id}`} className="py-5 block flex-1">
                        <Button className="w-full">Luyện tập </Button>
                    </Link>
                    <Button variant="secondary" className="w-full flex-1" onClick={handlePracticeScience} disabled={flashcard?.length < 4} title="Phải trên 4 từ mới có thể thực hiện">
