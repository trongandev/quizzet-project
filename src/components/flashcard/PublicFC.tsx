...
export default function PublicFC({ item }: any) {
    return (
        <Link
            ...
            className="relative group overflow-hidden w-full   bg-gray-200/80 hover:bg-gray-200 hover:scale-105  dark:bg-slate-800/50 border border-white/10 rounded-xl shadow-sm px-2 md:px-5 hover:shadow-md transition-all duration-300 flex justify-center flex-col gap-3 h-40">
            ...
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    <div className="w-[30px] h-[30px] overflow-hidden relative">
                        <Image src={item?.userId?.profilePicture} alt="" className="rounded-full w-full h-full absolute object-cover brightness-90 group-hover:brightness-100 duration-300" fill />
                    </div>
