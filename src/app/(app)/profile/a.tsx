...
// export default function CProfileC() {
...
//             <div className="w-full md:w-[1000px] xl:w-[1200px] "></div>
...
//                 </div>
//             </div>
//             <Button className="flex items-center gap-2 mt-3" onClick={showModal}>
...
//                     <Button className="">Bấm vào để tới trang cập nhật mật khẩu</Button>
//                 </Link>
//             </Modal>
