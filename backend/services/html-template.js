            ...
            <div class="container-sec">
                <div class="text-center">
                    <div class="welcome-section">
                        <div class="app-name">QUIZZET.SITE</div>
                    </div>
    ...
    <body>
        <div class="container">
            <div class="container-sec">
                <div class="text-center">
                    <div class="welcome-section">
                        <div class="app-name">TRONGAN.SITE</div>
                    </div>
                    <h2 class="black">Cảm ơn ${user || "bạn"} đã đóng góp ý kiến</h2>
                    <p class="black">Nội dung:</p>
                    <div class="otp-code">${content}</div>
                </div>
                <div class="footer-text">
                    <p>Nếu sản phẩm gặp lỗi, vui lòng <a href="mailto:trongandev@gmail.com">liên hệ</a> cho chúng tôi.</p>
                    <p>
                        Tham gia cộng đồng
                        <a href="https://discord.gg/mUqfzD3u" target="_blank"> Discord </a> ở đây.
                    </p>
                </div>
            </div>
        </div>
