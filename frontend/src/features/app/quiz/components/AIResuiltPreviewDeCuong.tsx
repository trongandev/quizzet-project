...
import { renderHightlightedContent } from '../../ai-center/components/renderCode'
                ...
                <DialogContent className="p-3 md:p-6 min-h-[80vh] w-full md:max-w-7xl overflow-x-scroll ">
                    ...
                    <div className="space-y-6">
                        <div className="flex items-center justify-between">
                            ...
                            <Button onClick={handleAddQuestion} className="flex items-center space-x-2 text-white bg-linear-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600">
                                <Plus className="h-4 w-4" />
                                <span>Thêm câu hỏi</span>
                            </Button>
                        </div>
