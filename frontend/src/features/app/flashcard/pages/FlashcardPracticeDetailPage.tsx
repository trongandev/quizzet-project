...
import FeatureFillBlank from '../components/FeatureFillBlank'
import FeatureChoose from '../components/FeatureChoose'
import FeatureListening from '../components/FeatureListening'
...
export default function FlashcardPracticeDetailPage() {
    ...
    useEffect(() => {
        ...
        const fetchAPI = async () => {
            const req = await flashcardService.getFlashcard(id_flashcard)
            setFlashcards(shuffle(req?.listFlashCards.flashcards || []))
